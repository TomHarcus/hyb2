...
def print_help():
    ...
    print("\t--input-table (-i)\tInput table You MANUALLY GENERATED")
    print("\t--output-id (-o)\tOut destination")
    print("\t--min-reads (-m)\tDESeq2 chimera count filtering threshold (default=2)")
    print("\t--range (-r)\tRange to define an interaction (default=100). 100nt from midpoint in both directions, meaning 200nt long for each defined interaction")
